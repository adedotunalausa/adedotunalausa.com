...
export const NavLinks= ({ open, setOpen }) => {
    return (
        <Ul open={open} className="navlinks">
            ...
            <Link className="link navlink" to={"/countries"} onClick={() => setOpen(!open)}><li>Journal</li></Link>
            <Link className="link navlink" to={"/maps"} onClick={() => setOpen(!open)}><li>Contact</li></Link>
        </Ul>
    )
}
