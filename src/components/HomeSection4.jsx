        ...
        <div>
            <div className="fourth-section">
                <div className="fourth-section-container">
                    <h2 className=" fade-in">SKills & Tools</h2>
                    <span className="butn-tech butn">Front-End Dev</span>
                    <div className="row fade-in tools-container">
                        <div className="box">
                    ...
                    <span className="butn-tech butn">Back-End Dev</span>
                    <div className="row fade-in tools-container">
                        <div className="box">
                            <div className="box-inner">
